                            ...
                            <div class="col-lg-12">
                                <div class="proceed-checkout">
                                    <ul>
                                        ...
                                        <li class="subtotal text-left mt-3">Subtotal <span>$240.00</span></li>
                                        <li class="subtotal text-left mt-3">Pajak <span>10%</span></li>
                                        <li class="subtotal text-left mt-3">Total Biaya <span>$440.00</span></li>
                                        <li class="subtotal text-left mt-3">Bank Transfer <span>Mandiri</span></li>
                                        <li class="subtotal text-left mt-3">No. Rekening <span>2208 1996 1403</span></li>
                                        <li class="subtotal text-left mt-3">Nama Penerima <span>Shayna</span></li>
                                    </ul>
